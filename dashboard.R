...
# Dieses Script erstellt die graphischen Auswertungen und Karten der zuvor im 
# Script Datacleaning erstellten Katasterdaten.

# Michael Hilti (michael.hilti@gmail.com)
# 2022-01-05, 16.15 Uhr
...
## Laden oder installieren der benötigen Libraries
...
quartierliste <- c("Affoltern", "Albisrieden", "Alt-Wiedikon", "Altstetten", "ausserhalb Stadtgebiet", "City",
                   ...
                   "Seebach", "Seefeld", "Sihlfeld", "Unterstrass", "Weinegg", "Werd", "Wipkingen",
                   "Witikon", "Wollishofen")
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      menuItem("Einführung", tabName = "einfuehrung", icon = icon("fas fa-info-circle")),
      menuItem("Verteilung Baumsorten", tabName = "verteilung_normal", icon = icon("fas fa-map-marked-alt")),
      menuItem("Heatmap Allergiebaumsorten", tabName = "allergie", icon = icon("fas fa-fire-alt")),
      menuItem("Plots", tabName = "charts", icon = icon("fas fa-chart-bar"), startExpanded = TRUE,
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "einfuehrung",
              h4("Graphische Auswertung des Baumkatasters der Stadt Zürich als Hilfsmittel für Allergiker"),
              h5("Dies ist der Scriptingteil meiner Masterarbeit «Graphische Auswertung des Baumkatasters der Stadt Zürich als Hilfsmittel für Allergiker» im Rahmen der Ausbildung MAS Data Science an der ZHAW in Winterthur. Das vorliegende Tool soll Allergikern dabei helfen einen passenden Wohnort in der Stadt Zürich zu evaluieren, der nicht in der Nähe von allergietreibenden Bäumen liegt."),
              h5("Die Auswertung basiert auf von der Stadt Zürich zur Verfügung gestellten Open Government Data. Zur Anwendung kamen dabei die beiden Datensätze ", a("Baumkatasterm (Stand 06.12.2021)", href = "https://data.stadt-zuerich.ch/dataset/0ae47115-8ddc-4ed9-9463-8fe41539d6b5"), "und ", a("Statistische Quartiere (Stand 06.12.2021)", href = "https://data.stadt-zuerich.ch/dataset/geo_statistische_quartiere"), "."),
              h5("In den beiden Kartenansichten «Verteilung Baumsorten» und «Heatmap Allergiebaumsorten» kann die Anwenderin graphischen nach verschiedenen Baumsorten und Quartieren auswerten. Die Plots dienen der zusätzlichen Unterstützung dieser Auswertungen."),
              h5("Die Scripts und die Beschreibung der Arbeit können auf meinem ", a("Github-Repository", href = "https://github.com/michael8000zh/baumkataster"), "heruntergeladen werden."),
              h5("Michael Hilti, 05.01.2021")
...
# Aufbau Hilfsfilter total Anzahl Bäume nach Quartier
total_pro_quartier <- reactive({
  kataster %>%
